...
contract BondingCurve is Ownable2Step, IBondingCurve {
    ...
    uint256 private constant TOTAL_SUPPLY_FACTOR = 250 ether;
    uint256 private constant CURVE_FACTOR = 2;
    uint256 private constant INITIAL_PRICE_FACTOR = 7;
    ...
    function setCredContract(address credContract_) external onlyOwner {
        ...
        emit CredContractSet(credContract_);
    }
