...
// import { PhiNFT1155 } from "./art/PhiNFT1155.sol";
// import { ERC1967Proxy } from "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";
// import { LibString } from "solady/utils/LibString.sol";
// import { SafeTransferLib } from "solady/utils/SafeTransferLib.sol";
// import { LibZip } from "solady/utils/LibZip.sol";
// import { MerkleProofLib } from "solady/utils/MerkleProofLib.sol";
// import { IPhiNFT1155 } from "./interfaces/IPhiNFT1155Ownable.sol";
...
//     IPhiFactory
// {
//     IContractDeployer private constant CONTRACT_DEPLOYER =
// IContractDeployer(0x0000000000000000000000000000000000008006);
//     ISystemContract private constant ACCOUNT_CODE_STORAGE =
// ISystemContract(0x0000000000000000000000000000000000008002);
...
//                                MODIFIERS
//     //////////////////////////////////////////////////////////////*/
//     /// @dev ReentrancyGuard modifier from solmate, copied here because it was added after storage layout was
// finalized
//     /// on first deploy
...
//             .RoyaltyConfiguration({ royaltyBPS: updateConfig_.royaltyBPS, royaltyRecipient:
// updateConfig_.royaltyRecipient });
...
//                 string memory snapshotImage_,
//                 bytes memory signature_
//             ) = abi.decode(encodedata_, (uint256, address, address, address, uint256, uint256, bytes32, string,
// bytes));
...
//             artAddress = _createNewNFTContract(currentArt, newArtId, createData_, credId, credChainId,
// verificationType);
...
//         returns (address)
//     {
//         // Get the implementation bytecode hash
//         bytes32 bytecodeHash = ACCOUNT_CODE_STORAGE.getRawCodeHash(erc1155ArtAddress);

//         // Generate salt for deterministic deployment
//         bytes32 salt = keccak256(abi.encodePacked(block.chainid, newArtId, credId));

//         // Prepare constructor args - in ZkSync, these need to be passed differently
//         bytes memory constructorArgs = abi.encode(credChainId, credId, verificationType);

//         // Deploy using ZkSync's native deployer without initialization call
//         address newArt = CONTRACT_DEPLOYER.create2(salt, bytecodeHash, constructorArgs);

//         if (newArt == address(0)) revert Create2FailedDeployment();
...
//         emit NewArtCreated(createData_.artist, credId, credChainId, newArtId, createData_.uri, address(newArt),
// tokenId);
